...
func (c *helloClient) Heathcheck(ctx context.Context, in *HealthcheckRequest, opts ...grpc.CallOption) (*HealthcheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pack1.Hello/Heathcheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloClient) Helloworld(ctx context.Context, in *HelloworldRequest, opts ...grpc.CallOption) (*HelloworldResponse, error) {
	out := new(HelloworldResponse)
	err := c.cc.Invoke(ctx, "/com.pack1.Hello/Helloworld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServer) Helloworld(context.Context, *HelloworldRequest) (*HelloworldResponse, error) {
...
func _Hello_Heathcheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pack1.Hello/Heathcheck",
	}
...
func _Hello_Helloworld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pack1.Hello/Helloworld",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
